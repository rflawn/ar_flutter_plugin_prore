...
class _LocalAndWebObjectsWidgetState extends State<LocalAndWebObjectsWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Place Virtual ProRe logo'),
        ),
        body: Container(
              ...
              child: Row(
                ...
                children: [
                  ElevatedButton(
                      ...
                      child: Text("Add/Remove ProRe\nlogo at Origin")),
                  SizedBox(width: 10,),
                  ElevatedButton(
                      onPressed: onLocalObjectAtOriginHouseButtonPressed,
                      child: Text("Add/Remove House\nlogo at Origin")),
                ],
              ),
  ...
  Future<void> onLocalObjectAtOriginButtonPressed() async {
    if (this.localObjectNode != null) {
      ...
      var newNode = ARNode(
          ...
          //uri: "Models/Prore/ResidentialBuildingsSet.gltf",
          uri: "Models/Prore/prorecube.gltf",
          //uri: "Models/Prore/birch_tree.gltf",
          //uri: 'Models/Prore/Hochhaus.gltf',
          //uri: "Models/Prore/proretable.gltf",
          //uri: "Models/Prore/landcruiser.gltf",
          //uri: "Models/Prore/building.gltf",
          scale: Vector3(10.1, 10.1, 10.1),
  ...
  Future<void> onLocalObjectAtOriginHouseButtonPressed() async {
    if (this.localObjectNode != null) {
      this.arObjectManager.removeNode(this.localObjectNode);
      this.localObjectNode = null;
    } else {
